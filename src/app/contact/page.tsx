      ...
      <div className="min-h-screen">
        <section className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="border border-[var(--gh-border-default)] rounded-lg p-8 bg-[var(--gh-canvas-subtle)]">
            ...
            <div className="mb-8 text-center pb-8 border-b border-[var(--gh-border-default)]">
              ...
              <div className="flex justify-center gap-6">
                <a
                  ...
                  className="flex items-center gap-2 text-[var(--gh-accent-fg)] hover:text-[var(--gh-accent-emphasis)] transition-colors"
                >
